...
CONF_ROOM_HEAT_ONLY_CLIMATES = "heat_only_climates"
...
CONF_DELTA = "delta"
CONF_DIRECTION_SWITCH_HYSTERESIS = "direction_switch_hysteresis"
CONF_T_TIME = "t_time"
CONF_UPDATE_INTERVAL = "update_interval"
CONF_MAX_OFFSET = "max_offset"
CONF_STEP_OFFSET = "step_offset"
CONF_HOLD_OFFSET_DECAY_STEP = "hold_offset_decay_step"
CONF_MIN_ACTION_INTERVAL = "min_action_interval"

CONF_OUTDOOR_MIN_FOR_WEATHER_SENSITIVE = "outdoor_min_for_weather_sensitive"
CONF_OUTDOOR_MAX_FOR_WEATHER_SENSITIVE = "outdoor_max_for_weather_sensitive"
CONF_COOL_OUTDOOR_TARGET_DELTA = "cool_outdoor_target_delta"
CONF_HEAT_OUTDOOR_TARGET_DELTA = "heat_outdoor_target_delta"
CONF_HEAT_ONLY_SHARED_HOLD_EXTRA = "heat_only_shared_hold_extra"
CONF_HEAT_ONLY_SHARED_HOLD_OUTDOOR_BELOW = "heat_only_shared_hold_outdoor_below"
...
DEFAULT_DELTA = 0.5
DEFAULT_DIRECTION_SWITCH_HYSTERESIS = 0.0
DEFAULT_T_TIME = 300
DEFAULT_UPDATE_INTERVAL = 45
DEFAULT_MAX_OFFSET = 2.0
DEFAULT_STEP_OFFSET = 0.5
DEFAULT_HOLD_OFFSET_DECAY_STEP = DEFAULT_STEP_OFFSET
...
DEFAULT_OUTDOOR_MIN_FOR_WEATHER_SENSITIVE = 0.0
DEFAULT_OUTDOOR_MAX_FOR_WEATHER_SENSITIVE = 50.0
DEFAULT_COOL_OUTDOOR_TARGET_DELTA = 2.0
DEFAULT_HEAT_OUTDOOR_TARGET_DELTA = 2.0
DEFAULT_HEAT_ONLY_SHARED_HOLD_EXTRA = 7.0
DEFAULT_HEAT_ONLY_SHARED_HOLD_OUTDOOR_BELOW = 10.0
...
OPTIONS_DEFAULTS: dict[str, object] = {
    ...
    CONF_DIRECTION_SWITCH_HYSTERESIS: DEFAULT_DIRECTION_SWITCH_HYSTERESIS,
    CONF_T_TIME: DEFAULT_T_TIME,
    CONF_UPDATE_INTERVAL: DEFAULT_UPDATE_INTERVAL,
    CONF_MAX_OFFSET: DEFAULT_MAX_OFFSET,
    CONF_STEP_OFFSET: DEFAULT_STEP_OFFSET,
    CONF_HOLD_OFFSET_DECAY_STEP: DEFAULT_HOLD_OFFSET_DECAY_STEP,
    ...
    CONF_OUTDOOR_MIN_FOR_WEATHER_SENSITIVE: DEFAULT_OUTDOOR_MIN_FOR_WEATHER_SENSITIVE,
    CONF_OUTDOOR_MAX_FOR_WEATHER_SENSITIVE: DEFAULT_OUTDOOR_MAX_FOR_WEATHER_SENSITIVE,
    CONF_COOL_OUTDOOR_TARGET_DELTA: DEFAULT_COOL_OUTDOOR_TARGET_DELTA,
    CONF_HEAT_OUTDOOR_TARGET_DELTA: DEFAULT_HEAT_OUTDOOR_TARGET_DELTA,
    CONF_HEAT_ONLY_SHARED_HOLD_EXTRA: DEFAULT_HEAT_ONLY_SHARED_HOLD_EXTRA,
    CONF_HEAT_ONLY_SHARED_HOLD_OUTDOOR_BELOW: DEFAULT_HEAT_ONLY_SHARED_HOLD_OUTDOOR_BELOW,
